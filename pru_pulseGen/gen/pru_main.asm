...
;* Date/Time created: Sun Mar  1 21:41:45 2015                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/root/ucla-nesl-pru-lib/examples/pulsegen")
...
$C$DW$9	.dwtag  DW_TAG_variable, DW_AT_name("IEP_TMR_CNT")
	...
	.global	||curTime||
	.common	||curTime||,8,1
$C$DW$10	.dwtag  DW_TAG_variable, DW_AT_name("curTime")
	.dwattr $C$DW$10, DW_AT_TI_symbol_name("curTime")
	.dwattr $C$DW$10, DW_AT_location[DW_OP_addr ||curTime||]
	...
	.global	||prevTime||
	.common	||prevTime||,8,1
$C$DW$11	.dwtag  DW_TAG_variable, DW_AT_name("prevTime")
	.dwattr $C$DW$11, DW_AT_TI_symbol_name("prevTime")
	.dwattr $C$DW$11, DW_AT_location[DW_OP_addr ||prevTime||]
...
;----------------------------------------------------------------------
;  43 | WAIT_MS(1000);                                                         
;  51 |     //      Receive timestamp from host to PRU                         
;----------------------------------------------------------------------
...
$1:     SUB      r0, r0, 1
	...
	.dwpsn	file "pru_main.c",line 52,column 26,is_stmt,isa 0
;----------------------------------------------------------------------
;  52 | struct rbuffer *rec_buf = (struct rbuffer *) (uint32_t) (SHARED_MEM_BAS
;     | E);                                                                    
;  54 | //  Receive buffer from host to PRU                                    
;----------------------------------------------------------------------
        LDI32     r0, 0x00010000        ; [] |52| 
        SBBO      &r0, r2, 0, 4         ; [] |52| rec_buf
	.dwpsn	file "pru_main.c",line 55,column 35,is_stmt,isa 0
;----------------------------------------------------------------------
;  55 | struct rbuffer *terminate_buf = (struct rbuffer *) (uint32_t) (SHARED_M
;     | EM_BASE + sizeof(struct rbuffer));                                     
;  57 | struct iep_time time;                                                  
;----------------------------------------------------------------------
        LDI32     r0, 0x00010404        ; [] |55| 
        SBBO      &r0, r2, 4, 4         ; [] |55| terminate_buf
	.dwpsn	file "pru_main.c",line 58,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  58 | init_iep_time(&time);                                                  
;----------------------------------------------------------------------
        ADD       r14, r2, 8            ; [] |58| time,time
$C$DW$103	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$103, DW_AT_low_pc(0x00)
	.dwattr $C$DW$103, DW_AT_name("init_iep_time")
	.dwattr $C$DW$103, DW_AT_TI_call
        JAL       r3.w2, ||init_iep_time|| ; [] |58| init_iep_time
	.dwpsn	file "pru_main.c",line 60,column 20,is_stmt,isa 0
;----------------------------------------------------------------------
;  60 | uint32_t waitTime = 0;                                                 
;  61 | //int curCycle = 0;                                                    
;----------------------------------------------------------------------
        LDI       r0, 0x0000            ; [] |60| 
        SBBO      &r0, r2, 28, 4        ; [] |60| waitTime
	.dwpsn	file "pru_main.c",line 63,column 15,is_stmt,isa 0
;----------------------------------------------------------------------
;  63 | short status = -1;                                                     
;----------------------------------------------------------------------
        LDI       r0.w0, 0xffff         ; [] |63| 
        SBBO      &r0.w0, r2, 32, 2     ; [] |63| status
	.dwpsn	file "pru_main.c",line 65,column 11,is_stmt,isa 0
;----------------------------------------------------------------------
;  65 | while(1) {                                                             
;  66 |             //if received sigint from host terminate                   
;----------------------------------------------------------------------
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L26||
;*
...
;* --------------------------------------------------------------------------*
||$C$L26||:    
	.dwpsn	file "pru_main.c",line 67,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
;  67 | if (rbuf_read_uint64(terminate_buf, &status)) {                        
;----------------------------------------------------------------------
        LBBO      &r14, r2, 4, 4        ; [] |67| terminate_buf
        ADD       r15, r2, 32           ; [] |67| status,status
$C$DW$104	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$104, DW_AT_low_pc(0x00)
	.dwattr $C$DW$104, DW_AT_name("rbuf_read_uint64")
	.dwattr $C$DW$104, DW_AT_TI_call
        JAL       r3.w2, ||rbuf_read_uint64|| ; [] |67| rbuf_read_uint64
        QBNE      ||$C$L27||, r14, 0x00 ; [] |67| 
;* --------------------------------------------------------------------------*
        QBEQ      ||$C$L28||, r15, 0x00 ; [] |67| 
;* --------------------------------------------------------------------------*
||$C$L27||:    
...
;  68 | DISABLE_IEP_TMR();                                                     
;----------------------------------------------------------------------
        LDI       r0, ||IEP_REG||       ; [] |68| IEP_REG
        LBBO      &r1, r0, 0, 4         ; [] |68| 
        LDI       r0, 0x0000            ; [] |68| 
        SBBO      &r0, r1, 0, 4         ; [] |68| 
	.dwpsn	file "pru_main.c",line 69,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
;  69 | terminate();                                                           
;----------------------------------------------------------------------
$C$DW$105	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$105, DW_AT_TI_call
        JAL       r3.w2, ||terminate||  ; [] |69| terminate
;* --------------------------------------------------------------------------*
||$C$L28||:    
	.dwpsn	file "pru_main.c",line 72,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
;  72 | waitTime = rbuf_read_uint64(rec_buf, &status);                         
;  73 | //if you received a new waitTime                                       
;----------------------------------------------------------------------
        LBBO      &r14, r2, 0, 4        ; [] |72| rec_buf
        ADD       r15, r2, 32           ; [] |72| status,status
$C$DW$106	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$106, DW_AT_low_pc(0x00)
	.dwattr $C$DW$106, DW_AT_name("rbuf_read_uint64")
	.dwattr $C$DW$106, DW_AT_TI_call
        JAL       r3.w2, ||rbuf_read_uint64|| ; [] |72| rbuf_read_uint64
        SBBO      &r14, r2, 28, 4       ; [] |72| waitTime
	.dwpsn	file "pru_main.c",line 74,column 3,is_stmt,isa 0
;----------------------------------------------------------------------
;  74 | if(waitTime != 0) {                                                    
;  75 |         //toggle pin for 50us                                          
;----------------------------------------------------------------------
        LBBO      &r0, r2, 28, 4        ; [] |74| waitTime
        QBEQ      ||$C$L26||, r0, 0x00  ; [] |74| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "pru_main.c",line 77,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
;  77 | if(first) {                                                            
;----------------------------------------------------------------------
        LDI       r0, ||first||         ; [] |77| first
        LBBO      &r0, r0, 0, 4         ; [] |77| 
        QBEQ      ||$C$L32||, r0, 0x00  ; [] |77| 
;* --------------------------------------------------------------------------*
...
;----------------------------------------------------------------------
        LDI       r0, 0x0000            ; [] |78| 
        LDI       r1, ||first||         ; [] |78| first
        SBBO      &r0, r1, 0, 4         ; [] |78| 
	.dwpsn	file "pru_main.c",line 79,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  79 | curTime = iep_get_time(&time);                                         
;----------------------------------------------------------------------
        ADD       r14, r2, 8            ; [] |79| time,time
$C$DW$107	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$107, DW_AT_low_pc(0x00)
	.dwattr $C$DW$107, DW_AT_name("iep_get_time")
	.dwattr $C$DW$107, DW_AT_TI_call
        JAL       r3.w2, ||iep_get_time|| ; [] |79| iep_get_time
        LDI       r0, ||curTime||       ; [] |79| curTime
        SBBO      &r14, r0, 0, 8        ; [] |79| 
...
$C$DW$108	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$108, DW_AT_TI_call
        JAL       r3.w2, ||assert_pin|| ; [] |81| assert_pin
...
$C$DW$110	.dwtag  DW_TAG_variable, DW_AT_name("_us")
	...
	.dwattr $C$DW$110, DW_AT_location[DW_OP_breg8 34]
        LDI       r0, 0x0031            ; [] |82| 
        SBBO      &r0, r2, 34, 4        ; [] |82| _us
        SUB       r1, r0, 0x01          ; [] |82| 
        SBBO      &r1, r2, 34, 4        ; [] |82| _us
        QBEQ      ||$C$L30||, r0, 0x00  ; [] |82| 
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L29||
;*
;*   Loop source line                : 82
...
$1:     SUB      r0.w0, r0.w0, 1
        QBNE     $1, r0.w0, 0          ; [] |82| 
        LBBO      &r0, r2, 34, 4        ; [] |82| _us
        SUB       r1, r0, 0x01          ; [] |82| 
        SBBO      &r1, r2, 34, 4        ; [] |82| _us
        QBNE      ||$C$L29||, r0, 0x00  ; [] |82| 
;* --------------------------------------------------------------------------*
||$C$L30||:    
        .newblock
        LDI      r0.w0, 96
...
;----------------------------------------------------------------------
;  83 | deassert_pin(P8_46);                                                   
;  86 | //spin until it is time for the next pulse                             
;----------------------------------------------------------------------
        LDI       r14, 0x0002           ; [] |83| 
$C$DW$111	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$111, DW_AT_TI_call
        JAL       r3.w2, ||deassert_pin|| ; [] |83| deassert_pin
	.dwpsn	file "pru_main.c",line 87,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
;  87 | while((curTime - prevTime) < (waitTime + offset_ns)) {                 
;----------------------------------------------------------------------
        JMP       ||$C$L32||            ; [] |87| 
;* --------------------------------------------------------------------------*
||$C$L31||:    
	.dwpsn	file "pru_main.c",line 88,column 5,is_stmt,isa 0
;----------------------------------------------------------------------
;  88 | curTime = iep_get_time(&time);                                         
;  91 | //jump out of loop                                                     
;----------------------------------------------------------------------
        ADD       r14, r2, 8            ; [] |88| time,time
$C$DW$112	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$112, DW_AT_low_pc(0x00)
	.dwattr $C$DW$112, DW_AT_name("iep_get_time")
	.dwattr $C$DW$112, DW_AT_TI_call
        JAL       r3.w2, ||iep_get_time|| ; [] |88| iep_get_time
        LDI       r0, ||curTime||       ; [] |88| curTime
        SBBO      &r14, r0, 0, 8        ; [] |88| 
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L32||
;* --------------------------------------------------------------------------*
||$C$L32||:    
	.dwpsn	file "pru_main.c",line 87,column 10,is_stmt,isa 0
        LBBO      &r0, r2, 28, 4        ; [] |87| waitTime
        ZERO      &r1, 4                ; [] |87| 
        LDI       r14, ||offset_ns||    ; [] |87| offset_ns
        LBBO      &r14, r14, 0, 8       ; [] |87| 
        ADD       r16, r14, r0          ; [] |87| 
        ADC       r17, r15, r1          ; [] |87| 
        LDI       r0, ||prevTime||      ; [] |87| prevTime
        LBBO      &r0, r0, 0, 8         ; [] |87| 
        LDI       r14, ||curTime||      ; [] |87| curTime
        LBBO      &r14, r14, 0, 8       ; [] |87| 
        RSB       r0, r0, r14           ; [] |87| 
        RSC       r1, r1, r15           ; [] |87| 
        QBLT      ||$C$L31||, r17, r1   ; [] |87| 
;* --------------------------------------------------------------------------*
        QBGT      ||$C$L33||, r17, r1   ; [] |87| 
;* --------------------------------------------------------------------------*
        QBLT      ||$C$L31||, r16, r0   ; [] |87| 
;* --------------------------------------------------------------------------*
||$C$L33||:    
...
$C$DW$113	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$113, DW_AT_TI_call
        JAL       r3.w2, ||assert_pin|| ; [] |93| assert_pin
...
$C$DW$115	.dwtag  DW_TAG_variable, DW_AT_name("_us")
	...
	.dwattr $C$DW$115, DW_AT_location[DW_OP_breg8 34]
        LDI       r0, 0x0031            ; [] |94| 
        SBBO      &r0, r2, 34, 4        ; [] |94| _us
        SUB       r1, r0, 0x01          ; [] |94| 
        SBBO      &r1, r2, 34, 4        ; [] |94| _us
        QBEQ      ||$C$L35||, r0, 0x00  ; [] |94| 
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L34||
;*
;*   Loop source line                : 94
...
$1:     SUB      r0.w0, r0.w0, 1
        QBNE     $1, r0.w0, 0          ; [] |94| 
        LBBO      &r0, r2, 34, 4        ; [] |94| _us
        SUB       r1, r0, 0x01          ; [] |94| 
        SBBO      &r1, r2, 34, 4        ; [] |94| _us
        QBNE      ||$C$L34||, r0, 0x00  ; [] |94| 
;* --------------------------------------------------------------------------*
||$C$L35||:    
        .newblock
        LDI      r0.w0, 96
...
$C$DW$116	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$116, DW_AT_TI_call
        JAL       r3.w2, ||deassert_pin|| ; [] |95| deassert_pin
	.dwpsn	file "pru_main.c",line 96,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
;  96 | prevTime = curTime;                                                    
;----------------------------------------------------------------------
        LDI       r0, ||curTime||       ; [] |96| curTime
        LBBO      &r0, r0, 0, 8         ; [] |96| 
        LDI       r14, ||prevTime||     ; [] |96| prevTime
        SBBO      &r0, r14, 0, 8        ; [] |96| 
	.dwpsn	file "pru_main.c",line 97,column 4,is_stmt,isa 0
;----------------------------------------------------------------------
;  97 | TRIG_INTC(3); // Trigger interrupt PRUEVENT_0                          
;  99 | //ready for new wait time                                              
;----------------------------------------------------------------------
        LDI       r31, 0x0023           ; [] |97| 
	.dwpsn	file "pru_main.c",line 65,column 11,is_stmt,isa 0
        JMP       ||$C$L26||            ; [] |65| 
;* --------------------------------------------------------------------------*
	...
	.dwattr $C$DW$95, DW_AT_TI_end_line(0x7b)
...
$C$DW$134	.dwtag  DW_TAG_enumerator, DW_AT_name("P9_26"), DW_AT_const_value(0x10000)
	...
	.dwattr $C$DW$T$39, DW_AT_decl_line(0x0a)
